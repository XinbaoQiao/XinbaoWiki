...
assert.match(styles, /\.wiki-portal-name-text \{[\s\S]*animation: wiki-name-write 1\.35s cubic-bezier\(\.21, \.8, \.22, 1\) \.1s both;[\s\S]*\}/, 'homepage name reveal uses a slower handwriting-like animation speed');
