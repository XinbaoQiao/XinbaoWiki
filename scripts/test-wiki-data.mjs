...
assert.match(styles, /\.wiki-portal-cube-pin \{[\s\S]*position: absolute[\s\S]*\.wiki-portal-cube-pin\[aria-pressed="true"\]/, "the active-face pin control has a compact visible pinned state");
...
assert.ok(!homepagePortal.includes('cubeTextureWords') && !styles.includes('.wiki-portal-cube-texture') && styles.includes("--portal-cube-paper:") && styles.includes("opacity: .24"), "opaque paper-like faces prevent mirrored typography while inactive faces preserve the cube silhouette in reading mode");
