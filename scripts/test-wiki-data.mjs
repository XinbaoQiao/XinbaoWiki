...
assert.ok(homepagePortal.includes("if (browseView !== 'cube' || activeCubeFace) return") && homepagePortal.includes('if (targetFace === relatedFace') && homepagePortal.includes('scheduleCubeFace(face)'), "typographic cube locks the selected reading face until the pointer leaves the stable stage");
