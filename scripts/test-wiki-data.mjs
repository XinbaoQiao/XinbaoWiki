...
assert.match(styles, /\.wiki-portal-grid-cube \.wiki-portal-cube-face-front a,[\s\S]*data-active-face="front"[\s\S]*padding-block: 3px/, 'the denser publication face preserves every classified link without clipping its final project rows');
