...
assert.match(styles, /\.wiki-portal-news-list \{[\s\S]*grid-template-columns: 1fr;[\s\S]*padding: 0 12px 6px;/, 'homepage milestones use one compact reading column at every breakpoint');
