...
assert.match(wikiSearch, /const activeLanguage = showLanguageSelect \? selectedLanguage : preferredLanguage;/, 'wiki search lets the portal language selector control result language');
...
assert.match(styles, /\.wiki-portal-name \{[\s\S]*font-family: var\(--font-signature\);[\s\S]*font-size: 78px;[\s\S]*\}/, 'homepage centers Xinbao Qiao in the Alex Brush signature face');
