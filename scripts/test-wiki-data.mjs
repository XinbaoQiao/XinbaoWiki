...
assert.ok(!homepagePortal.includes('onPointerOut=') && styles.includes('width: min(100%, 760px)') && styles.includes('margin-inline: auto'), "the stable centered cube stage, rather than moving faces, owns pointer reset behavior");
