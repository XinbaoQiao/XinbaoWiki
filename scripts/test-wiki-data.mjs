...
assert.ok(styles.includes("perspective: 1750px") && styles.includes("transform-style: preserve-3d"), "desktop typographic cube uses a restrained real perspective context");
...
assert.ok(!homepagePortal.includes('cubeTextureWords') && !styles.includes('.wiki-portal-cube-texture') && styles.includes("var(--wiki-bg) 94%") && styles.includes("opacity: .12"), "opaque visible faces prevent mirrored typography while inactive faces fade during reading mode");
