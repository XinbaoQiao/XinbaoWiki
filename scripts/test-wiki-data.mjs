...
assert.match(styles, /\.wiki-portal-block h3 \{[\s\S]*font-family: var\(--font-sans\);[\s\S]*font-size: 20px;[\s\S]*font-style: normal;[\s\S]*font-weight: 800;[\s\S]*letter-spacing: 0;[\s\S]*\}/, 'homepage browse top-level headings clearly outrank secondary taxonomy labels');
