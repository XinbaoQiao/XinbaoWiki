...
assert.ok(homepagePortal.includes("const cubeShellFaceNames = ['back', 'left', 'bottom'] as const") && homepagePortal.includes("browseView === 'cube' && cubeShellFaceNames.map"), "typographic cube closes all six geometric faces without adding decorative panels to list view");
...
assert.ok(styles.includes("rotateY(180deg) translateZ") && styles.includes("rotateY(-90deg) translateZ") && styles.includes("rotateX(-90deg) translateZ"), "typographic cube defines back, left, and bottom faces to eliminate the open corner");
...
assert.ok(styles.includes(".wiki-portal-cube-texture") && styles.includes("pointer-events: none") && styles.includes("3%, transparent"), "structural cube faces are typography-led, nearly transparent, and non-interactive");
