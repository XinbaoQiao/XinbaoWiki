...
assert.match(homepagePortal, /const updateEntries[\s\S]*ICML 2026 paper accepted[\s\S]*Completed master’s degree[\s\S]*AAAI 2026 paper accepted[\s\S]*Started full-time research internship[\s\S]*Two ICLR 2025 papers accepted[\s\S]*dateTime: '2023-03'[\s\S]*dateTime: '2022-09'[\s\S]*dateTime: '2022-07'/, 'homepage keeps the complete high-signal English update archive in reverse chronology');
assert.match(homepagePortal, /ICML 2026 论文录用[\s\S]*完成硕士学位[\s\S]*AAAI 2026 论文录用[\s\S]*开始全职研究实习[\s\S]*两篇 ICLR 2025 论文录用[\s\S]*dateTime: '2023-03'[\s\S]*dateTime: '2022-09'[\s\S]*dateTime: '2022-07'/, 'homepage keeps the complete Chinese update archive in reverse chronology');
