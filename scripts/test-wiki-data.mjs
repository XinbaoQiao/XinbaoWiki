...
assert.ok(homepagePortal.includes("onPointerLeave={() => setActiveCubeFace(null)}") && homepagePortal.includes("browseView !== 'cube' || activeCubeFace") && homepagePortal.includes("data-active-face={activeCubeFace ?? undefined}"), "typographic cube locks the selected reading face until the pointer leaves the stage");
