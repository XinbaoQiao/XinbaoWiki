...
const copy = {
  en: {
    ...
    greeting: 'Hey, you made it 👋 Pull up a chair. Here for the paper lore, a project rabbit hole, or whatever Xinbao is cooking up lately? Good vibes, real receipts.',
  ...
  zh: {
    ...
    greeting: '嗨，来都来了，先坐会儿 👋 想聊论文、项目，还是看看鑫宝最近又在折腾什么？这边主打一个：梗可以有，瞎编不可以。',
