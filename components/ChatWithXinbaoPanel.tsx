...
const copy = {
  en: {
    ...
    greeting: 'Hey, glad you stopped by Xinbaopedia. I’m the AI guide here. Curious what Xinbao has been working on lately, or is there a paper or project you’d like to talk about? We can start wherever you like. If the public material does not have the answer, I’ll tell you honestly.',
  ...
  zh: {
    ...
    greeting: '嗨，很高兴你来逛 Xinbaopedia。我是这里的 AI 小助手。你是想聊聊乔鑫宝最近在做什么，还是对某篇论文、某个项目比较好奇？都可以，我们就从你感兴趣的地方开始。公开资料里没有的，我也会坦白告诉你。',
