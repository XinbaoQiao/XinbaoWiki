...
const copy = {
  en: {
    ...
    greeting: 'Hi, I am a lightweight digital-proxy skill, distilled on the spot from Xinbao Qiao’s public homepage and research notes. Ask me about his research, publications, projects, academic background, or public contact information.',
  ...
  zh: {
    ...
    greeting: '你好，我是被乔鑫宝从公开主页和研究资料里顷刻炼化出来的数字分身 skill，负责回答他的研究方向、论文项目、学术经历和公开联系方式，恐怖如斯。',
