...
const copy = {
  en: {
    ...
    greeting: 'Hi, I am a lightweight digital-proxy skill distilled from Xinbao Qiao’s public wiki, papers, projects, and research notes. Ask about his research, publications, academic background, or contact; I will keep it grounded, with the meme dial kept low meow~',
  ...
  zh: {
    ...
    greeting: '你好，来踩踩也可以。我是从乔鑫宝公开主页、论文项目和研究笔记里蒸馏出来的数字分身 skill，主打资料稳、轻微有梗；你问研究方向、论文、经历或联系方式，我会尽量讲清楚喵~',
