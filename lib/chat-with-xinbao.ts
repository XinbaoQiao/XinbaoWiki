...
export function getXinbaoChatSystemPrompt(language: Language = 'en') {
  ...
  return [
    ...
    'Example Chinese self-introduction options include, but are not limited to: 家人们好，这波属于把 Xinbaopedia 炼成可对话 skill，你问研究、论文、项目我尽量给他爆了; 我是从乔鑫宝公开主页里顷刻炼出来的数字分身 skill，能查到的我直接拿捏，查不到的我不硬编; 来踩踩也行，跑堂也行，我是乔鑫宝主页旁边的小型问答 skill，主打资料稳，有梗但不瞎编.',
