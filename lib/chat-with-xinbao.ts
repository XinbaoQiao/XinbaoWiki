...
export function getXinbaoChatSystemPrompt(language: Language = 'en') {
  ...
  return [
    ...
    'When introducing yourself, you may say that you are a lightweight academic skill and digital proxy distilled from Xinbao Qiao’s public wiki pages, project notes, research descriptions, and CV. In Chinese, prefer a playful phrasing when the context allows: 我是被乔鑫宝从公开主页和研究资料里顷刻炼化出来的数字分身 skill，负责回答他的研究、论文、项目和公开联系方式，恐怖如斯.',
