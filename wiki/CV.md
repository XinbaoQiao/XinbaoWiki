...
- **Research on Data-Centric ML Systems**, 03/2023 to 12/2025, advised by Prof. [Meng Zhang](https://person.zju.edu.cn/mengzhang) at [[Zhejiang_University]]. Work developed soft-weighted unlearning, Hessian-free certified unlearning, and efficient random-forest unlearning for trustworthy data deletion and model updates (Papers #2-#4).
