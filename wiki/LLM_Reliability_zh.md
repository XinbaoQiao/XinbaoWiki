...
本页为乔鑫宝 2025 年在 [[NUSRI_CQ|NUSRI-CQ]] 的研究实习提供背景。传记中该阶段记录为可信 LLM 系统与合成数据评估。这里的可靠性涵盖幻觉、数据污染、评估泄漏、递归合成数据使用，以及对生成输出的错误信任等问题。它被链接到 [[Synthetic_Data_and_Model_Collapse|合成数据]]，因为生成文本或多模态数据可能进入未来训练管线。
