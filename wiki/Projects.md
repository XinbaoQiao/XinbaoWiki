...
[[Collaborative_Evaluation]] studies verification without raw-data exchange. It is used in the ICML 2026 model-collapse work to replace a single low-resource, biased verifier with multi-party Wasserstein-geometry proxies.
