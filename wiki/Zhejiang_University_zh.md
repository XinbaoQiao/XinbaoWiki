...
乔鑫宝在浙江大学攻读人工智能硕士，并于 2025 年毕业；硕士导师为 [[Meng_Zhang|张萌]]。传记记录其专业 GPA 为 90/100，排名 3/25。浙江大学阶段是其本科通信工程背景与后来博士阶段 [[AI_and_Networks|AI 与网络]] 方向之间的桥梁：研究从一般 AI 系统转向直接改变模型行为的数据操作。
